...
##Patient Allelic Frequency is set to WT with no TP53 mutation
endometrial_order$Allele.Freq..T.[endometrial_order$`P53 Mut` == 0] <- "WT"
...
##Create new variable x with patients numbered 1-351
...
jpeg("Patient sCNA vs TP53 VAF.jpeg", height= 600, width= 1300, units= "px", res= 120)
grid.newpage()
